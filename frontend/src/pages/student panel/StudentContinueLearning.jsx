...
// import { Search, Bell, Download, PlayCircle, ChevronRight, ChevronDown, ChevronUp, Lock, FileText, Link2, MessageSquare, Calendar, Pause, Volume2, Settings, Maximize2, Users, GraduationCap, Wallet, BarChart3, Upload, Plus } from 'lucide-react'
...
//           <nav className="flex items-center gap-[4px] text-[13px] text-[#94a3b8]">
//             <span>My Courses</span>
//             <ChevronRight className="h-[14px] w-[14px]" />
//             <span>UI/UX Masterclass</span>
//             <ChevronRight className="h-[14px] w-[14px]" />
//             <span className="font-semibold text-[#0f172a]">Module 4: Accessibility</span>
//           </nav>
//           <div className="flex flex-col font-bold h-[29px] justify-center leading-[0] text-[#0f172a] text-[24px] mt-[4px]">
//             Continue Learning
//           </div>
//         </div>
...
//             <div className="h-[36px] w-[36px] rounded-[6px] bg-[#e8f5ff] flex items-center justify-center text-[14px] font-bold text-[#5b3df6]">A</div>
...
//                     <div className="space-y-[12px]">
//                       <div className="flex items-center justify-between rounded-[8px] border border-black/[0.08] p-[14px]">
//                         <div className="flex items-center gap-[12px]">
...
//                           </div>
//                           <div>
//                             <div className="text-[13px] font-semibold text-[#0f172a]">Semantic HTML Cheat Sheet</div>
//                             <div className="text-[11px] text-[#94a3b8]">PDF Document • 2.4 MB</div>
//                           </div>
//                         </div>
...
//                         <div className="flex items-center gap-[12px]">
//                           <div className="h-[36px] w-[36px] rounded-[6px] bg-[#e8f5ff] flex items-center justify-center">
//                             <Link2 className="h-[16px] w-[16px] text-[#5b3df6]" />
//                           </div>
//                           <div>
//                             <div className="text-[13px] font-semibold text-[#0f172a]">WCAG 2.1 Guidelines</div>
//                             <div className="text-[11px] text-[#94a3b8]">External Link • W3C Official Site</div>
//                           </div>
//                         </div>
//                         <button className="border border-black/[0.08] flex items-center gap-[8px] h-[36px] justify-center px-[14px] rounded-[6px] bg-white">
//                           <Link2 className="h-[14px] w-[14px] text-[#5b3df6]" />
//                           <div className="flex flex-col font-medium h-[15px] justify-center leading-[0] text-[#0f172a] text-[12px]">Open Link</div>
//                         </button>
//                       </div>
//                     </div>
//                   </div>
//                 ) : (
//                   <p className="text-[13px] text-[#94a3b8]">No content for this tab yet.</p>
//                 )}
//               </div>
//             </div>
//           </div>
